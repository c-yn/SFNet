import os
import torch
from data.data_load_ots import train_dataloader
    ...
    for epoch_idx in range(epoch, args.num_epoch + 1):
        ...
        for iter_idx, batch_data in enumerate(dataloader):
            ...
            if iter_idx%eval_now==0 and iter_idx>0 and (epoch_idx>20 or epoch_idx == 1):
                ...
                val_ots = _valid(model, args, epoch_idx)
                print('%03d epoch \n Average  PSNR %.2f dB' % (epoch_idx, val_ots))
                writer.add_scalar('PSNR', val_ots, epoch_idx)
                if val_ots >= best_psnr:
